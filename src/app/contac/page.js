  ...
  return (
    <div>
      <div className=" flex justify-center items-center h-[700px] gap-9 bg-gradient-to-b from-[#D2E4FF] from-5% via-[#448EFE] via-60% to-[#FAFBFC]">
        <div className=" w-[450px] p-4 bg-gray-200 rounded-xl bottom-2 border-[#F0E8E8] shadow-xl">
        ...
        <div className=" flex flex-col justify-center items-center w-[500px]">
          ...
          <input type="email" placeholder="email" className=" p-2 m-2 w-80 rounded-lg border-none "></input>
          <input type="text" placeholder="masukan saran atau bantuan" className=" p-2 m-2 w-80 rounded-lg border-none "></input>
